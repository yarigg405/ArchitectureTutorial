...
namespace HECS.Controllers
{
    ...
    public class InputController : MonoBehaviour
    {
        ...
        private const float CamepadCompensationY = 1f;
        ...
        public ReactivePressButton ActionQButton = new ReactivePressButton();
        ...
        private void CheckInputType()
        {
            ...
            if (!haveGamePad && InputTypeReactive.CurrentValue == InputType.KeyboardMouse)
                return;
            else if (haveGamePad && InputTypeReactive.CurrentValue == InputType.KeyboardMouse)
                return;
        ...
        private void AssignSubscriber(Action action, ReactivePressButton reactivePressButton, PressOrRelease pressedOrRelease)
        {
            switch (pressedOrRelease)
            {
        ...
        private void ActionButtons()
        {
            ...
            ActionQButton.SetPressed(Input.GetButtonDown(ActionQr));
            ActionQButton.SetReleased(Input.GetButtonUp(ActionQr));
        ...
        private void GamePadInput()
        {
            ...
            horizontalMove = Input.GetAxis(LeftStickY);

            InputCameraX = Input.GetAxis(RightStickX);
            InputCameraY = Input.GetAxis(RightStickY) * CamepadCompensationY;
            ActionButtons();
            CalculateDirection();
        }
